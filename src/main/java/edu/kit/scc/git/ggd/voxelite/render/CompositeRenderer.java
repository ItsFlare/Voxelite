...
public class CompositeRenderer {
    ...
    public void render(GeometryBuffer gBuffer, ArrayTexture2D shadowMap) {
        ...
        OpenGL.use(PROGRAM, va, () -> {
            PROGRAM.planes.set(new Vec2f(Main.INSTANCE.getRenderer().getCamera().getNear(), Main.INSTANCE.getRenderer().getCamera().getFar()));
            ...
            PROGRAM.depth.bind(4, gBuffer.depth());
            PROGRAM.projection.set(Main.INSTANCE.getRenderer().getCamera().projection());
